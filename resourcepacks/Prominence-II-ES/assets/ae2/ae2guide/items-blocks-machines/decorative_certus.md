...
navigation:
  ...
  title: Bloques Decorativos de Certus
  icon: quartz_stairs
  position: 010
categories:
...
Los <ItemLink id="quartz_block" /> se pueden craftear, fundir y cortar en piedra para obtener algunos bloques decorativos de construcción.
